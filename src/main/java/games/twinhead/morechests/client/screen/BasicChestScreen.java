...
public class BasicChestScreen extends HandledScreen<AbstractChestScreenHandler> {

    private static final Identifier TEXTURE =
            new Identifier("minecraft", "textures/gui/container/generic_54.png");

    public BasicChestScreen(AbstractChestScreenHandler handler, PlayerInventory inventory, Text title) {
