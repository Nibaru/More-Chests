...
public class ScreenHandlerRegistry {
    ...
    public static void registerAllScreenHandlers() {
        ...
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(MoreChests.MOD_ID, "basic_chest_screen_handler"), BASIC_CHEST_SCREEN_HANDLER);
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(MoreChests.MOD_ID, "iron_chest_screen_handler"), IRON_CHEST_SCREEN_HANDLER);
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(MoreChests.MOD_ID, "gold_chest_screen_handler"), GOLD_CHEST_SCREEN_HANDLER);
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(MoreChests.MOD_ID, "diamond_chest_screen_handler"), DIAMOND_CHEST_SCREEN_HANDLER);
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(MoreChests.MOD_ID, "netherite_chest_screen_handler"), NETHERITE_CHEST_SCREEN_HANDLER);
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(MoreChests.MOD_ID, "copper_chest_screen_handler"), COPPER_CHEST_SCREEN_HANDLER);
    }
}
