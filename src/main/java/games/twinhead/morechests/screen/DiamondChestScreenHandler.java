...
public class DiamondChestScreenHandler extends ScreenHandler {
    ...
    public final ChestTypes type = ChestTypes.DIAMOND;

    public DiamondChestScreenHandler(int syncId, PlayerInventory inventory) {
        this(syncId, inventory, new SimpleInventory(ChestTypes.DIAMOND.rows * ChestTypes.DIAMOND.columns));
    }

    public DiamondChestScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(ScreenHandlerRegistry.DIAMOND_CHEST_SCREEN_HANDLER, syncId);
        checkSize(inventory, ChestTypes.DIAMOND.rows * ChestTypes.DIAMOND.columns);
