...
public class BasicChestScreenHandler extends AbstractChestScreenHandler {
    ...
    public BasicChestScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf packetByteBuf) {
    ...
    public BasicChestScreenHandler(ChestTypes type, int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(ScreenHandlerRegistry.BASIC_CHEST_SCREEN_HANDLER.get(), type ,syncId, playerInventory);
